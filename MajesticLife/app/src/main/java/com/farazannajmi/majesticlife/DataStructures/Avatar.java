...
@Entity(tableName = "Avatar_table",
        foreignKeys = {
                ...
                @ForeignKey(entity = AvatarItem.class,
                        parentColumns = "Background_ResIndex",
                        childColumns = "ResourceIndex",
                        onDelete = CASCADE),
                @ForeignKey(entity = AvatarItem.class,
                        parentColumns = "Skin_ResIndex",
                        childColumns = "ResourceIndex",
                        onDelete = CASCADE),
                @ForeignKey(entity = AvatarItem.class,
                        parentColumns = "Cloth_ResIndex",
                        childColumns = "ResourceIndex",
                        onDelete = CASCADE),
                @ForeignKey(entity = AvatarItem.class,
                        parentColumns = "Eyes_ResIndex",
                        childColumns = "ResourceIndex",
                        onDelete = CASCADE),
                @ForeignKey(entity = AvatarItem.class,
                        parentColumns = "Mouth_ResIndex",
                        childColumns = "ResourceIndex",
                        onDelete = CASCADE),
                @ForeignKey(entity = AvatarItem.class,
                        parentColumns = "Crown_ResIndex",
                        childColumns = "ResourceIndex",
                        onDelete = CASCADE)})
public class Avatar
{
